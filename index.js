...
for (let i = 0; i < slideCount * 3; i++)
  addSlide(i, `https://picsum.photos/id/${10 + i * 2}/200/200`);

let rotation = 2;

// let rotations = [-12, 2, 9, 26]
// let nextRotation;
requestAnimationFrame(function render(t) {
  moveFilm(t);
  three.render();
  //     if (!nextRotation && Math.abs(rotation-film.rotation.y)<0.1){
  //         nextRotation = t+1000;
  //     }
  //     if (nextRotation && t>nextRotation){
